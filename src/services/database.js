...
class DatabaseService {
  ...
  createTables() {
    // Destructure scene table schemas
    const {
      createSceneTable,
    ...
    // Destructure schedule table schemas
    const { createScheduleTable } = scheduleTableSchemas;

    // Destructure multiscene table schemas
    const { createMultiScenesTable, createMultiSceneScenesTable } =
      multisceneTableSchemas;

    // Destructure sequence table schemas
    const { createSequencesTable, createSequenceMultiScenesTable } =
      sequenceTableSchemas;
    ...
    // Scene-related table schemas are now imported from database/scene.js
    // Schedule-related table schemas are now imported from database/schedule.js
    // Multi-scene related table schemas are now imported from database/multiscene.js
    // Sequence-related table schemas are now imported from database/sequence.js
    ...
    // DALI-related table schemas are now imported from database/dali.js
  ...
  // findScheduleIdByIdentifier is now in database/schedule.js module
  // findMultiSceneIdByAddress is now in database/multiscene.js module
  // findSequenceIdByAddress is now in database/sequence.js module
  ...
  // bulkImportSingleScene and findOrCreateItemForScene are now in database/scene.js module
