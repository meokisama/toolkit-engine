...
export const knxController = {
  setKnxConfig: (unitIp, canId, knxConfig) => ipcRenderer.invoke("rcu:setKnxConfig", unitIp, canId, knxConfig),
  getKnxConfig: (params) => ipcRenderer.invoke("rcu:getKnxConfig", params),
  triggerKnx: (params) => ipcRenderer.invoke("rcu:triggerKnx", params),
  deleteKnxConfig: (params) => ipcRenderer.invoke("rcu:deleteKnxConfig", params),
  deleteAllKnxConfigs: (unitIp, canId) => ipcRenderer.invoke("rcu:deleteAllKnxConfigs", unitIp, canId),
};
