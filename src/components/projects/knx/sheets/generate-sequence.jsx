    ...
    try {
      ...
      results.forEach((result, index) => {
        if (result.status === 'fulfilled') {
          ...
          errorCount++;
          console.error(
            `Failed to create KNX item for sequence ${selectedItemsList[index]}:`,
            result.reason
          );
        }
      });
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader>
          ...
          <SheetDescription>
            Select sequence items to generate corresponding KNX devices.
          </SheetDescription>
        </SheetHeader>
                    ...
                    <div className="w-[30%]">
                      <div className="flex items-center gap-2">
                        <span className="truncate">
                          {item.name || `Sequence ${item.address}`}{" "}
