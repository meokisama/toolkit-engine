...
async function deleteConfigByType(unitIp, canId, configType) {
  switch (configType) {
    case "scenes":
      await window.electronAPI.rcuController.deleteAllScenes(unitIp, canId);
      break;
    case "schedules":
      await window.electronAPI.rcuController.deleteAllSchedules(unitIp, canId);
      break;
    case "multiScenes":
      await window.electronAPI.rcuController.deleteAllMultiScenes(unitIp, canId);
      break;
    case "sequences":
      await window.electronAPI.rcuController.deleteAllSequences(unitIp, canId);
      break;
    case "knx":
      await window.electronAPI.rcuController.deleteAllKnxConfigs(unitIp, canId);
      break;
    case "curtain":
      await window.electronAPI.rcuController.deleteAllCurtains(unitIp, canId);
      break;
    default:
