...
const MultiSceneCard = memo(
  ({ multiScene, onTrigger, onDelete, loading }) => (
...
export function TriggerMultiSceneDialog({ open, onOpenChange, unit }) {
  ...
  const handleLoadMultiSceneInfo = useCallback(async () => {
    ...
    try {
      ...
      const result = await window.electronAPI.rcuController.getMultiSceneInformation({
        unitIp: unit.ip_address,
        canId: unit.id_can,
        multiSceneIndex: index,
      });
            ...
            <div className="flex justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  size="lg"
                  disabled={
                    loadingState.loadingAllMultiScenes || loadingState.loadingInfo
                  }
                  className="flex items-center gap-2"
                >
              ...
              {state.showMultiScenes && state.multiScenes.length > 0 ? (
                ...
                <div className="flex items-center justify-center h-full mt-10">
                  <div className="text-center text-muted-foreground">
                    ...
                    <p className="text-sm">
                      Use "Load Multi-Scene" or "Load All Multi-Scenes" to display multi-scene
                      information
                    </p>
                  </div>
                </div>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete Multi-Scene #{state.deleteConfirmDialog.multiSceneIndex}{" "}
              ({state.deleteConfirmDialog.multiSceneName})? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
