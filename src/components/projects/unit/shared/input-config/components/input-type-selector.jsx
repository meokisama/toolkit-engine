...
import { InputFunctionSubmenu } from "./input-function-submenu";

export const InputTypeSelector = ({ currentInputType, availableInputFunctions, currentInputFunction, inputIndex, unitType, onInputTypeChange }) => {
  return (
    <div>
