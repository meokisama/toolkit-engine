export function registerIOConfigHandlers(ipcMain, rcu) {
  ...
  ipcMain.handle("rcu:setOutputState", async (event, { canId, outputIndex, value, unitIp }) => {
    try {
  ...
  ipcMain.handle("rcu:setInputState", async (event, { canId, inputIndex, value, unitIp }) => {
    try {
  ...
  ipcMain.handle("rcu:setupInputConfig", async (event, { unitIp, canId, inputConfig }) => {
    try {
  ...
  ipcMain.handle("rcu:setupBatchInputConfigs", async (event, { unitIp, canId, inputConfigs, maxBytes }) => {
    try {
  ...
  ipcMain.handle("rcu:setOutputAssign", async (event, unitIp, canId, outputIndex, lightingAddress) => {
    try {
      return await rcu.setOutputAssign(unitIp, canId, outputIndex, lightingAddress);
    } catch (error) {
  ...
  ipcMain.handle("rcu:setAllOutputAssignments", async (event, unitIp, canId, outputAssignments) => {
    try {
      return await rcu.setAllOutputAssignments(unitIp, canId, outputAssignments);
    } catch (error) {
  ...
  ipcMain.handle("rcu:setOutputDelayOff", async (event, unitIp, canId, outputIndex, delayOff) => {
    try {
      return await rcu.setOutputDelayOff(unitIp, canId, outputIndex, delayOff);
    } catch (error) {
  ...
  ipcMain.handle("rcu:setOutputDelayOn", async (event, unitIp, canId, outputIndex, delayOn) => {
    try {
  ...
  ipcMain.handle("rcu:setOutputConfig", async (event, unitIp, canId, outputIndex, config) => {
    try {
  ...
  ipcMain.handle("rcu:setupBatchLightingOutputs", async (event, { unitIp, canId, lightingOutputs, maxBytes }) => {
    try {
      return await rcu.setupBatchLightingOutputs(unitIp, canId, lightingOutputs, maxBytes);
    } catch (error) {
