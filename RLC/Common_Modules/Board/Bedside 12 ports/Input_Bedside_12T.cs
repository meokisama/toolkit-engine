...
namespace RLC
{
    public partial class Input_Bedside_12T : Form
    {
        int act;
        public string Group_path;
        public RLC1 XForm;
        const int SLInput_RLC = 12;
        ...
        private void Input_Bedside_12T_Load(object sender, EventArgs e)
        {
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_Bedside_12T Config = new ConfigIO_Bedside_12T();            
        ...
        private void Input_Bedside_12T_FormClosing(object sender, FormClosingEventArgs e)
        {
            XForm.Enabled = true;
