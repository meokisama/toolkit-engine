...
namespace RLC
{
    public partial class Input_RCU_9IN_4RL : Form
    {
        /****************************Output*************************/

        const int SLRelay_AO = 4;
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_RCU_9IN_4RL Config = new ConfigIO_RCU_9IN_4RL();            
