...
namespace RLC
{
    public partial class Input_GNT_EXT_12RL_12AO : Form
    {
        /****************************Output*************************/

        const int SLRelay_AO = 24;
        ...
        public Input_GNT_EXT_12RL_12AO()
        {
            InitializeComponent();
                ...
                for (int j = 0; j < inputh; j++)
                {
                    ...
                    if (XForm.confignetwork == true)
                    {
                        ...
                        if (dem < SL_Lighting_Out)
                        {
                            ...
                            Relay_On[dem].Location = new Point(loc_x + 77, loc_y - 5);
