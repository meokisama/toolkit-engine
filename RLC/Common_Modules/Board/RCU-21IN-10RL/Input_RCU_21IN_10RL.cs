...
namespace RLC
{
    public partial class Input_RCU_21IN_10RL : Form
    {
        /****************************Output*************************/

        const int SLRelay_AO = 10;
        ...
        private void AddComponent()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                for (int j = 0; j < SLInput_RLC; j++)
                {
                    ...
                    lb.Size = new Size(lb.Size.Width - 35, 13);
                    lb.Top = loc_y;
                    lb.Left = loc_x;
                    ...
                    else
                    {
                        ...
                        if (data_size > 0)
                        {
                            ...
                            else // Air Conditioner ouput config
                            {
                                ...
                                {
                                    UInt32 val = Convert.ToUInt32(XForm.Substring(',', idx++, input));
                                    ...
                                    {
                                        xInfo.SetValueDirect(__makeref(XForm.AC_Out_Configs[op - SL_Lighting_Out]), Convert.ToUInt16(val));
                                    }
                                    else
                                    {
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_RCU_21IN_10RL Config = new ConfigIO_RCU_21IN_10RL();
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                for (int j = 0; j < inputh; j++)
                {
                    ...
                    if (dem < SL_Lighting_Out)
                    {
                        ...
                        Lighting_Ouput_Cfg[dem].Location = new Point(loc_x + 55, loc_y - 5);
                    ...
                    else
                    {
                        ...
                        Air_Cond_Ouput_Cfg[dem - SL_Lighting_Out].Location = new Point(loc_x + 55, loc_y - 5);
        ...
        private void Relay_Off_Click(object sender, EventArgs e)
        {
            ...
            string IP = XForm.grBoardNetwork[2, index].Value.ToString();
            string ID = XForm.grBoardNetwork[3, index].Value.ToString();
            Set_Output_State(IP, ID, 255, Convert.ToByte(bt.Name));
            bt.Visible = false;
        ...
        private void Relay_On_Click(object sender, EventArgs e)
        {
            ...
            string IP = XForm.grBoardNetwork[2, index].Value.ToString();
            string ID = XForm.grBoardNetwork[3, index].Value.ToString();
            Set_Output_State(IP, ID, 0, Convert.ToByte(bt.Name));
            bt.Visible = false;
