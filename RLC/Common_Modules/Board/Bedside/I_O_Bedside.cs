...
namespace RLC
{
    public partial class Input_Bedside : Form
    {
        int act;
        public string Group_path;
        public RLC1 XForm;
        const int SLInput_RLC = 17;
        ...
        private void AddComponent()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                for (int j = 0; j < SLInput_RLC; j++)
                {
                    ...
                    {
                        loc_y = loc_y + 50;
                        if (j % 5 == 0) loc_y = loc_y + 50;
                    }
                    inputl++;

                    if ((XForm.confignetwork == true) && (dem > 2))
                    {
                        //btn Input on
        ...
        private void Input_Bedside_Load(object sender, EventArgs e)
        {
            ...
            cbx_Group[0].Enabled = false;
            cbx_Function[0].Enabled = false;
            Add_Group[0].Enabled = false;
            Edit_Group[0].Enabled = false;
            Config_IO[0].Enabled = false;
            ...
            cbx_Function[3].Items.Add("MAKE_UP_ROOM");
            cbx_Function[3].SelectedIndex = 0;

            cbx_Function[4].Items.Clear();
            cbx_Function[4].Items.Add("IP_UNUSED");
            cbx_Function[4].Items.Add("DO_NOT_DISTURB");
            cbx_Function[4].SelectedIndex = 0;
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_Bedside Config = new ConfigIO_Bedside();
