...
namespace RLC
{
    public partial class ConfigIO_RLC_new_20_ports : Form
    {
        int act;
        Input_RLC_new_20_ports RLCForm;
        ...
        public ConfigIO_RLC_new_20_ports()
        {
            InitializeComponent();
        }

        public void Initialize(Input_RLC_new_20_ports Form)
        {
