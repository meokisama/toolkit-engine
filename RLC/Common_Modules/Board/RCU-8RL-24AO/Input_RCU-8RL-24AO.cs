...
namespace RLC
{
    public partial class Input_RCU_8RL_24AO : Form
    {
        /****************************Output*************************/
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_RCU_8RL_24AO Config = new ConfigIO_RCU_8RL_24AO();            
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                for (int j = 0; j < inputh; j++)
                {
                    ...
                    if (dem < SLRelay_AO)
                    {
                        ...
                        {
                            ip = inputl - 8;
                            lb.Text = "AO 1." + ip.ToString();
                        }
                        else if (inputl <= 24)
                        {
                            ip = inputl - 16;
                            lb.Text = "AO 2." + ip.ToString();
                        }
                        else
                        {
                            ip = inputl - 24;
                            lb.Text = "AO 3." + ip.ToString();
                        }
                    }
                    else
                    {
