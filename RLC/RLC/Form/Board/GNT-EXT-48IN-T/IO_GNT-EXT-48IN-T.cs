...
namespace RLC
{
    public partial class ConfigIO_GNT_EXT_48IN_T : Form
    {
        int act;
        Input_GNT_EXT_48IN_T RLCForm;
        ...
        public ConfigIO_GNT_EXT_48IN_T()
        {
            InitializeComponent();
        }

        public void Initialize(Input_GNT_EXT_48IN_T Form)
        {
        ...
        private void btn_Clr_ActiveGroup_Click(object sender, EventArgs e)
        {
            ...
            int i;
            for (i = gr_ActiveGroup.CurrentCell.RowIndex; i < gr_ActiveGroup.RowCount - 1; i++)
            {
        ...
        {
            int led_Stat = RLCForm.IO[RLCForm.input_Index].Led_Status & 12;
            ...
            RLCForm.IO[RLCForm.input_Index].Led_Status = led_Stat + Display + Convert.ToInt16(chk_Nightlight.Checked) * 16 + Convert.ToInt16(chk_Backlight.Checked) * 32;
        ...
        private void rbtn_ON_OFF_CheckedChanged(object sender, EventArgs e)
        {
            chk_Nightlight.Enabled = rbtn_ON_OFF.Checked;
        }

        private void rbtn_2colors_CheckedChanged(object sender, EventArgs e)
        {
            chk_Nightlight.Enabled = rbtn_2colors.Checked;
        }
