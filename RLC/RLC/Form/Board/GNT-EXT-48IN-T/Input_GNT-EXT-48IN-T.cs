...
namespace RLC
{
    public partial class Input_GNT_EXT_48IN_T : Form
    {
        int act;
        ...
        private void Input_GNT_EXT_48IN_T_Load(object sender, EventArgs e)
        {
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_GNT_EXT_48IN_T Config = new ConfigIO_GNT_EXT_48IN_T();            
        ...
        private void Input_GNT_EXT_48IN_T_FormClosing(object sender, FormClosingEventArgs e)
        {
            XForm.Enabled = true;
