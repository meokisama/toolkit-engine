...
namespace RLC
{
    public partial class Input_RCU_21IN_10RL_T : Form
    {
        /****************************Output*************************/
                ...
                else
                {
                    ...
                    if (dem < SLInput_RLC)
                    {
                        ...
                        if (tmp < cbx_Function[dem].Items.Count)
                            ...
                            MessageBox.Show("Error: Type of Input " + (dem + 1).ToString() + " is unknown. Please don't save config and use RLC Toolkit with higher verion");
                    }
                    else
                    {
                        op++;
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_RCU_21IN_10RL_T Config = new ConfigIO_RCU_21IN_10RL_T();
