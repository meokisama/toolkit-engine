...
namespace RLC
{
    public partial class ConfigIO_RCU_21IN_10RL_T : Form
    {
        int act;
        Input_RCU_21IN_10RL_T RLCForm;
        ...
        public ConfigIO_RCU_21IN_10RL_T()
        {
            InitializeComponent();
        }

        public void Initialize(Input_RCU_21IN_10RL_T Form)
        {
            this.RLCForm = Form;
