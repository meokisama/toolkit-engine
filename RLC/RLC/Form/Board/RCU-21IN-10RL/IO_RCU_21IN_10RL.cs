...
namespace RLC
{
    public partial class ConfigIO_RCU_21IN_10RL : Form
    {
        int act;
        Input_RCU_21IN_10RL RLCForm;
        ...
        public ConfigIO_RCU_21IN_10RL()
        {
            InitializeComponent();
        }

        public void Initialize(Input_RCU_21IN_10RL Form)
        {
            this.RLCForm = Form;
