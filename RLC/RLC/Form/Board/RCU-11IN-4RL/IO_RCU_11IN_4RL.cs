...
namespace RLC
{
    public partial class ConfigIO_RCU_11IN_4RL : Form
    {
        int act;
        Input_RCU_11IN_4RL RLCForm;
        ...
        public ConfigIO_RCU_11IN_4RL()
        {
            InitializeComponent();
        }

        public void Initialize(Input_RCU_11IN_4RL Form)
        {
        ...
        private void gr_ActiveGroup_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    int i;
                    string strDisp, strVal = null;
                    strDisp = gr_ActiveGroup.Rows[e.RowIndex].Cells[1].Value.ToString();
                    try
                    {
                        strVal = strDisp.Substring(0, strDisp.IndexOf('%'));
                    }
                    catch
                    {
                        strVal = strDisp;
                    ...
                    //int value = Convert.ToInt16(gr_ActiveGroup.Rows[e.RowIndex].Cells[1].Value.ToString());
                    int value = Convert.ToInt16(strVal);
                    if (value < 0) gr_ActiveGroup.Rows[e.RowIndex].Cells[1].Value = "0%";
