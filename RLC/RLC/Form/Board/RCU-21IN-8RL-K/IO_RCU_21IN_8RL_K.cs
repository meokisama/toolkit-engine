...
namespace RLC
{
    public partial class ConfigIO_RCU_21IN_8RL_K : Form
    {
        int act;
        Input_RCU_21IN_8RL_K RLCForm;
        ...
        public ConfigIO_RCU_21IN_8RL_K()
        {
            InitializeComponent();
        }

        public void Initialize(Input_RCU_21IN_8RL_K Form)
        {
            this.RLCForm = Form;
