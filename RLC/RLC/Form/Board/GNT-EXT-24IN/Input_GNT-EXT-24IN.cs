...
namespace RLC
{
    public partial class Input_GNT_EXT_24IN : Form
    {
        int act;
        public string Group_path;
        public RLC1 XForm;
        const int SLInput_RLC = 24;
        ...
        private void AddComponent()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                for (int j = 0; j < SLInput_RLC; j++)
                {
                    ...
                    lb.Size = new Size(lb.Size.Width, 16);
                    lb.Top = loc_y;
                    lb.Left = loc_x;
        ...
        private void Input_GNT_EXT_24IN_Load(object sender, EventArgs e)
        {
        ...
        private void Config_Click(object sender, EventArgs e)
        {
            ...
            ConfigIO_GNT_EXT_24IN Config = new ConfigIO_GNT_EXT_24IN();            
        ...
        private void Input_GNT_EXT_24IN_FormClosing(object sender, FormClosingEventArgs e)
        {
            XForm.Enabled = true;
